...
export default function InventarioInsumosTab({ user }) {
  const {
    inventario,
    loading,
    loadInventario,
    deleteItem,
  } = useCalidad2InventarioMedicamentos('INSUMO_MEDICO_QUIRURGICO');
    ...
    <div className="space-y-4">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">
                {searchTerm
                  ...
                  : 'No hay insumos médico-quirúrgicos registrados en el inventario'}
              </p>
              {!searchTerm && (
      ...
      <Dialog open={showForm} onOpenChange={() => handleCloseForm(false)}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {editingItem ? 'Editar Insumo Médico' : 'Nuevo Insumo Médico'}
            </DialogTitle>
          </DialogHeader>
          <InventarioForm
            item={editingItem}
